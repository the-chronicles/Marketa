...
export default function SellerProfileScreen() {
  ...
  const menuItems = [
    ...
    { id: 3, title: 'Store Location', icon: MapPin, color: '#f59e0b' },
  ...
  const stats = [
    { label: 'Total Sales', value: '₦245,000', color: colors.primary },
    { label: 'Food Items', value: '23', color: '#3b82f6' },
    { label: 'Rating', value: '4.8★', color: '#f59e0b' },
    { label: 'Orders', value: '156', color: '#ef4444' },
  ];

  const badges = [
    { id: 1, title: 'Verified Vendor', icon: '✅', color: colors.primary },
    { id: 2, title: 'Top Seller', icon: '🏆', color: '#f59e0b' },
    { id: 3, title: 'Fast Service', icon: '⚡', color: '#3b82f6' },
  ];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={dynamicStyles.profileHeader}>
          <View style={styles.avatarContainer}>
            <Text style={dynamicStyles.avatar}>👨‍🍳</Text>
            <View style={styles.verifiedBadge}>
              <Text style={styles.verifiedText}>✓</Text>
            </View>
          </View>
          <Text style={dynamicStyles.userName}>{user?.name || 'Mama Simi Kitchen'}</Text>
          <Text style={dynamicStyles.userEmail}>{user?.email || 'mamasimi@ui.edu.ng'}</Text>
          <Text style={dynamicStyles.userRole}>Food Vendor • University of Ibadan</Text>
          
          <View style={styles.ratingContainer}>
            <Star size={16} color="#f59e0b" />
            <Text style={dynamicStyles.rating}>4.8</Text>
            <Text style={dynamicStyles.ratingCount}>(156 reviews)</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <Text style={dynamicStyles.sectionTitle}>Vendor Achievements</Text>
          ...
          <View style={dynamicStyles.quickSettingsCard}>
            <View style={dynamicStyles.settingRow}>
              <View style={styles.settingLeft}>
                ...
                <Text style={dynamicStyles.settingText}>Order Notifications</Text>
              </View>
              <Switch
