...
export default function GamesScreen() {
  const games = [
    {
      id: 1,
      title: 'Food Match Mania',
      description: 'Match Nigerian foods while waiting for delivery',
    ...
    {
      id: 2,
      title: 'UI Food Trivia',
      description: 'Test your knowledge about Nigerian cuisine',
    ...
    },
    {
      id: 3,
      title: 'Delivery Rush',
      description: 'Help our rider deliver food across campus',
  ...
  const achievements = [
    { id: 1, title: 'First Order', description: 'Complete your first food order', icon: '🏆', unlocked: true },
    { id: 2, title: 'Speed Eater', description: 'Order 10 times in one day', icon: '⚡', unlocked: true },
    { id: 3, title: 'Food Master', description: 'Try all food categories', icon: '🧠', unlocked: false },
    { id: 4, title: 'Loyal Customer', description: 'Order 100 times total', icon: '👑', unlocked: false },
  ];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>Play games while waiting for food</Text>
          </View>
