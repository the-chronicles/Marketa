  ...
  const conversations = [
    {
      ...
      lastMessage: 'Your jollof rice is ready for pickup! 🍚',
      time: '2 mins ago',
      unread: 2,
      avatar: '👨‍🍳',
      type: 'vendor',
    ...
    {
      id: 2,
      name: 'Delivery Rider - Mike',
      lastMessage: 'On my way to your location 🚴‍♂️',
      time: '5 mins ago',
      unread: 0,
      avatar: '🚴‍♂️',
      type: 'rider',
    ...
    },
    {
      ...
      lastMessage: 'Thank you for ordering! Your fried rice is being prepared',
      time: '15 mins ago',
      unread: 0,
      avatar: '🍽️',
      type: 'vendor',
    ...
    },
    {
      id: 4,
      name: 'Buka Express',
      lastMessage: 'We have fresh amala available now! 🍲',
      time: '1 hour ago',
      unread: 1,
      avatar: '🏪',
      type: 'vendor',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tipsContainer}>
        ...
        <Text style={styles.tipsText}>
          • Ask vendors about ingredients and spice levels
          • Share your location with delivery riders
          • Rate your food experience after delivery
        </Text>
      </View>
    </SafeAreaView>
  );
